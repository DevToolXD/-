...
export const THEMES = [
  ...
  //  대성당·라이히스탁을 한 화면에 담은 대형 테마. 밤의 금박 유리 화면.
  {
    ...
    swatch: ["#0a0910", "#d4a417", "#c8102e"],
    preview: {
      kind: "germany",
      bg: "linear-gradient(180deg, #0b0912 0%, #14111c 52%, #2a2011 100%)",
      ink: "#f6f1e6",
      muted: "#9c917c",
      card: "rgba(24, 20, 30, 0.62)",
      edge: "rgba(212, 164, 23, 0.55)",
      accent: "linear-gradient(180deg, #d21331 0%, #8f0b20 100%)",
      onAccent: "#ffeec9",
      radius: "8px",
      blur: "7px",
      shadow: "0 8px 22px rgba(0, 0, 0, 0.6)",
      spec: "rgba(255, 236, 190, 0.22)",
    },
  },
];
