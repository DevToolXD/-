...
6. **테마**: 상단의 "테마" 탭(또는 학생 사이드바 6번째 항목)에서 화면 전체의
   ...
   | 신성로마제국 (962–1806, 제1제국) | 금빛 바탕 + 옅게 깔린 검은 쌍두수리 |
   | 독일제국 (1871–1918, 제2제국) | 검정·하양·빨강 삼색기 |
   | 바이마르 공화국 (1919–1933) | 흑·적·금을 처음 국기로 삼은 공화국 |
   | 독일연방공화국 (1949–현재) | 오늘의 독일, 흑·적·금 |

   독일 테마는 화면 맨 위에 그 시대의 국기 띠를 깔고, 카드 테두리와 강조색을
   함께 바꿉니다. 국기 문양은 외부 이미지 없이 인라인 SVG로 직접 그렸습니다.

   > **1933~1945년 나치 독일(제3제국)은 테마로 만들지 않았습니다.**
   > 하켄크로이츠는 독일 형법 86a조가 지금도 전시를 금지하는 혐오 상징이고,
   > 이 앱은 초등학생이 쓰는 학급 앱입니다. 테마 화면에도 같은 안내를 띄웁니다.

   여섯 테마 모두 본문·메뉴 글자의 명암비를 실제로 재서 WCAG 권장선(4.5:1)을
